...
export const ChatWindow = () => {
  ...
  return (
    <ScrollToBottom className="flex-1 h-full scrollbar-hide" initialScrollBehavior="smooth" followButtonClassName="hidden">
      <div className="p-4 md:p-8 flex flex-col min-h-full max-w-5xl mx-auto w-full">
        <AnimatePresence>
